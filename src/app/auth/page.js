      ...
      <div style={{ width: '100%', maxWidth: 420, background: 'var(--surface)', border: '1px solid var(--border2)', padding: '48px 40px' }}>
        ...
        {tab === 'signin' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ textAlign: 'right', marginTop: -8 }}>
              <span onClick={() => { switchTab('forgot'); setFpEmail(siEmail); }} style={{ fontSize: 10, color: 'var(--text-muted)', cursor: 'pointer', textDecoration: 'underline', letterSpacing: '0.06em' }}>Forgot password?</span>
            </div>
            ...
            <div style={{ fontSize: 11, color: 'var(--text-muted)', textAlign: 'center' }}>
              No account? <span style={{ color: 'var(--green)', cursor: 'pointer', textDecoration: 'underline' }} onClick={() => switchTab('signup')}>Create one</span>
            </div>
          </div>
        )}
        ...
        {tab === 'signup' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <GoogleBtn onClick={handleGoogle} />
            <div style={{ fontSize: 11, color: 'var(--text-muted)', textAlign: 'center' }}>
              Already have an account? <span style={{ color: 'var(--green)', cursor: 'pointer', textDecoration: 'underline' }} onClick={() => switchTab('signin')}>Sign in</span>
            </div>
          </div>
        )}
        ...
        {tab === 'forgot' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ fontSize: 12, color: 'var(--text-muted)', lineHeight: 1.7 }}>Enter your email and we'll send you a link to reset your password.</div>
            ...
            <div style={{ fontSize: 11, color: 'var(--text-muted)', textAlign: 'center' }}>
              Remembered it? <span style={{ color: 'var(--green)', cursor: 'pointer', textDecoration: 'underline' }} onClick={() => switchTab('signin')}>Back to sign in</span>
            </div>
          </div>
        )}
